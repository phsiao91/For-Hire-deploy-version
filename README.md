...
Resume builder app to store a client's information using Ruby on Rails through multiple end points and rendering the information on a custom visually appeling and respomsive template.
Utilization of Bcrypt authentication and sessions to store user login information.
Responsive front end using Reat.js and npm libraries to improve user experience and a seamless flow to make building a resume an easier task.
